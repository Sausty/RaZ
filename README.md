...
| **Rendering** | - OpenGL 3.3 or 4.5 (Vulkan and Metal in progress)<br/>- Standard (Blinn-Phong) & PBR (Cook-Torrance) material models<br/>- Deferred rendering, using a custom render graph<br/>- Camera (perspective/orthographic)<br/>- Light sources (point & directional)<br/>- Cubemap<br/>- Normal mapping                                                                                                                                         |
